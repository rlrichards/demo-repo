...
We're going to go ahead and create our own branch now by going back to the console to (1) `git branch "new-branch-name"` (2) `git checkout "new-branch-name"`. When we make changes to a branch we add and commit exactly the same but when we push we `git push origin new-branch-name`
