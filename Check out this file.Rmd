...
When you're ready save this file and head back over to your shell. To (1) `git add` this file (2) `git commit -m ""` this file with a commit message in the quotes, and (3) `git push origin master` this file up to your github repository!
